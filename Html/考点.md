...
![](https://raw.githubusercontent.com/77jump/interview-of-summary/sjzou/image/02.png)
...
##  考点4：cookie、localstroage、sessionStorage 的区别？优缺点？
...
3.重要内容 HTML 代码放在最前：搜索引擎抓取 HTML 顺序是从上到下，有的4.搜索引擎对抓取长度有限制，保证重要内容一定会被抓取
